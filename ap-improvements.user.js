    ...
    for (const anime of seriesList) {
      ...
      <div class="anitracker-big-list-item">
        <a href="/anime/${anime.session}" title="${toHtmlCodes(anime.title)}" style="display: flex; gap: 16px;">
          <div class="anitracker-image-wrapper" style="height: 60px; width: 60px;">
...
function openNotificationsModal() {
  ...
  async function next() {
    ...
    if (queue.length > 0 && $('#anitracker-notifications-list-spinner').length) next();
    else done();
  }
  ...
  $('#anitracker-modal-body').off('scroll').on('scroll', function() {
...
function openBookmarksModal() {
  ...
  <div class="btn-group anitracker-sort-method-btns" style="margin-left: 8px; height: 40px;">
    ...
    if (action === 'image') {
      ...
      $.anitrackerCachedScript('https://html2canvas.hertzen.com/dist/html2canvas.min.js', function() {
        ...
        html2canvas($('.anitracker-modal-list-container')[0], { allowTaint:true, scale:0.8, backgroundColor:null }).then(function(canvas) {
          ...
          <div id="anitracker-bookmark-share-result" class="anitracker-center-content" style="height:100%; margin-left: auto;margin-right: auto;"></div>`).appendTo('#anitracker-modal-body');
  ...
  $('#anitracker-modal-body').off('scroll').on('scroll', () => {
...
function openBookmarkStatusEditModal(id, adding=false) {
  ...
  <div style="display:flex;gap:10px;">
    <div class="anitracker-bookmark-edit-side" style="width:12em;">
